...
import './Employersignup.css'; // Ensure you have appropriate styles for the popup
import Img from '../../../assets/marawiwork.jpg';
import { FaTimes, FaCalendarAlt } from 'react-icons/fa';
import { useNavigate } from 'react-router-dom';

const Employersignup = ({ onToggleSignIn }) => {
  ...
  return (
    <div className="employer-popup">
      <div className="employer-content">
        ...
        <h2>Create account as an Employer</h2>
