...
const PostJob = () => {
    ...
    return (
        <div className="flex justify-center p-5">
            <form className="w-full max-w-5xl bg-gray-100 p-8 rounded-lg shadow-lg">
                <div className="flex justify-between mb-5">
                    <div className="flex flex-col gap-5 w-1/2">
                        <div className="flex flex-col mb-4"> {/* Added mb-4 for bottom margin */}
                ...
                <div className="flex gap-5 mb-5">
                    <div className="flex flex-col w-1/2 space-y-4"> {/* Added space-y-4 for vertical space */}
